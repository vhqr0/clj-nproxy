...
(def ec-sha256-sign (partial sign "SHA256withECDSA"))
(def ec-sha384-sign (partial sign "SHA384withECDSA"))
(def ec-sha512-sign (partial sign "SHA512withECDSA"))
(def ec-sha256-verify (partial verify "SHA256withECDSA"))
(def ec-sha384-verify (partial verify "SHA384withECDSA"))
(def ec-sha512-verify (partial verify "SHA512withECDSA"))
...
(def secp256r1-sha256-sign ec-sha256-sign)
(def secp384r1-sha384-sign ec-sha384-sign)
(def secp521r1-sha512-sign ec-sha512-sign)
(def secp256r1-sha256-verify ec-sha256-verify)
